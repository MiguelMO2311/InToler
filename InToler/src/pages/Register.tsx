...
const Register: React.FC = () => {
  ...
  return (
    <div className="bg-cover bg-center h-screen transition-all duration-1000" style={{ backgroundImage: "url('/imgs/img_fondo_register.jpg')", backgroundSize: "cover", maxHeight: "670px" }}>
