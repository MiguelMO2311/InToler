...
const LogIn: React.FC = () => {
  ...
  return (
    <div className="bg-cover bg-center h-screen transition-all duration-1000" style={{ backgroundImage: "url('/imgs/img_fondo_login.jpg')", backgroundSize: '45%', maxHeight: "640px" }}>
      <div className="flex justify-center items-center pt-24 border-dashed">
        {/* Bloque Izquierdo (Calendario) */}
        <div className="w-1/5  bg-yellow-500 rounded-xl bg-opacity-50 text-black hover:bg-white absolute top-52 left-12">
        ...
        <div className="w-[500px] hover:bg-yellow-500 hover:bg-opacity-50 p-5 ml-22 rounded-xl absolute top-32 ">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <button className="bg-yellow-700 hover:bg-yellow-600 text-white font-bold py-2  rounded focus:outline-none focus:shadow-outline ml-[40%] mt-20" type="submit">
                Iniciar sesión
              </button>
            </div>
          </form>
        ...
        <div className="w-28 items-center self-center rounded-xl absolute right-[150px] top-[250px] px-2  font-semibold bg-blue-400 bg-opacity-15 hover:bg-yellow-500">
          {weatherData && (
            <div>
